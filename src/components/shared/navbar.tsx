        ...
        >
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                    ...
                    <Link href="/register?role=chef" className="hover:text-[#183B32] transition">Become a Chef</Link>
                </nav>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-[#183B32] hover:bg-[#112B24] text-white text-sm font-medium px-5 py-2.5 rounded-full flex items-center gap-2 transition shadow-sm"
                    >
                        Get Started
